...
Despite this uncertainty, cooperation persists across time and across complex systems. Individuals coordinate activity, organizations manage large-scale production, and societies maintain institutions that operate across generations.

The persistence of cooperation despite uncertainty raises a fundamental question: how are complex cooperative systems able to continue across time?

This book begins by examining the most basic condition shared by all systems that persist: **continuation**.
...
Families persist when members continue to provide care, support, and shared responsibility. Organizations continue when participants fulfil roles, perform work, and maintain operational structures. Economic systems function when individuals and institutions continue to produce goods, exchange services, and uphold agreements.
